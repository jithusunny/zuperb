QUOTES = [
    ...
    {
        "quote": "Whatever begins in anger, ends in shame.",
        "author": "Benjamin Franklin",
    },
    {
        "quote": "Without discipline, no matter how talented you are, you’re nothing.",
        "author": "Mike Tyson",
    },
    {
    ...
    {
        "quote": "Take the understanding of the East and the knowledge of the West, and then seek.",
    ...
    {"quote": "When you die, you can't see sunsets.", "author": "Hayao Miyazaki"},
    {"quote": "He who does not desire power is fit to hold it.", "author": "Plato"},
    {
        "quote": "Expectation is the root of all heartache.",
        "author": "William Shakespeare",
    },
    {
        "quote": "You cannot hope to make progress in areas where you have taken no action.",
        "author": "Epictetus",
    },
    {
    ...
    {
        "quote": "Don't worry about losing. If it is right, it happens. The main thing is not to hurry. Nothing good gets away.",
        "author": "John Steinbeck",
    },
    {
        "quote": "A mistake repeated more than once is a choice.",
        "author": "Paulo Coelho",
    },
    {"quote": "The best fighter is never angry.", "author": "Lao Tzu"},
    {
        "quote": "The art of living well and the art of dying well are the same.",
        "author": "Epictetus",
    },
    {
    ...
    {
        "quote": "We suffer more often in our imagination than reality.",
        "author": "Seneca",
    },
    {
    ...
    {
        "quote": "If you are distressed by anything external, the pain is not due to the thing itself but to your own estimate of it; and this you have the power to revoke at any moment.",
        "author": "Marcus Aurelius",
    },
    {
    ...
    {
        "quote": "We have power over our minds, not outside events. Realize this and you will find strength.",
        "author": "Marcus Aurelius",
    },
    {
    ...
    {"quote": "Don't talk about your philosophy, embody it.", "author": "Epictetus"},
    {
        "quote": "Life isn't as serious as the mind makes it out to be.",
        "author": "Eckhart Tolle",
    },
    {
        "quote": "Whenever your mind becomes scattered, use your breath to take hold of your mind again.",
    ...
    {
        "quote": "When you are washing the dishes, washing the dishes must be the most important thing in life.",
        "author": "Thich Nhat Hanh",
    },
    {
    ...
    {
        "quote": "Regard [a friend] as loyal, and you will make him loyal.",
        "author": "Seneca",
    },
    {
    ...
    {
        "quote": "You didn't come into this world. You came out of it, like a wave from the ocean. You are not a stranger here.",
        "author": "Alan Watts",
    },
    {
        "quote": "The morning glory which blooms for an hour differs not at heart from the giant pine, which lives for a thousand years.",
        "author": "Alan Watts",
    },
    {
        "quote": "In looking out upon the world, we forget that the world is looking at itself.",
        "author": "Alan Watts",
    },
    {
    ...
    {"quote": "If you get the message, hang up the phone.", "author": "Alan Watts"},
    {
    ...
    {
        "quote": "People sometimes fail to live because they are always preparing to live.",
        "author": "Alan Watts",
    },
    {
        "quote": "By going out of your mind, you come to your senses.",
        "author": "Alan Watts",
    },
    {
        "quote": "You can make any human activity into meditation simply by being completely with it and doing it just to do it.",
        "author": "Alan Watts",
    },
    {
    ...
    {
        "quote": "Throughout this life, you can never be certain of living long enough to take another breath.",
        "author": "Huang Po",
    },
    {"quote": "Let go, or be dragged.", "author": "Zen Proverb"},
    {
        "quote": "To accept some idea of truth without experiencing it is like a painting of a cake on paper which you cannot eat.",
        "author": "Suzuki Roshi",
    },
    {
    ...
    {
        "quote": "The mind is like a fertile garden in which anything that is planted, flowers or weeds, will grow.",
        "author": "Bruce Lee",
    },
    {"quote": "Everyone is in the best seat.", "author": "John Cage"},
]
